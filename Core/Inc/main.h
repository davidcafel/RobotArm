...
#define EnableMotor2_Pin GPIO_PIN_9
...
#define EnableMotor1_Pin GPIO_PIN_1
#define EnableMotor1_GPIO_Port GPIOG
...
#define EnableMotor3_Pin GPIO_PIN_7
#define EnableMotor3_GPIO_Port GPIOD
