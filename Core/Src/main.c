...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOF, Step2_Pin | Dir2_Pin | EnableMotor2_Pin,
			GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOC, Step3_Pin | Enable4_Pin | Dir4_Pin,
			GPIO_PIN_RESET);
	...
	HAL_GPIO_WritePin(GPIOG,
			Step1_Pin | EnableMotor1_Pin | USB_PowerSwitchOn_Pin,
			GPIO_PIN_RESET);
